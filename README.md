...
![а4374](https://github.com/user-attachments/assets/0afc68a3-bf0c-476c-a4c5-0ef7cf0803f4)

Надоело скакать между вкладками, соотносить характеристики товаров при формировании требований к технике? Тогда данное приложение для тебя
...
Шаг 5: Получение выбранных характеристик
- При нажатии на кнопку "Копировать характеристики" в буфер копирования поместится таблица с выбранными значениями характеристик.
